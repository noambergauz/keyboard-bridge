...
class KeyboardEventProcessor:
    ...
    def process_composition_event(self, data: Dict[str, Any]) -> Optional[KeyboardEvent]:
    ...
    def _update_composition_state(self, event: KeyboardEvent):
        ...
        if event.event_type == 'composition':
            ...
            if (self.dead_key_state.get('active') and 
                self.dead_key_state.get('key') == event.key_code):
    ...
    def get_composition_text(self) -> str:
        ...
        return self.composition_state.get('text', '')
        
    def clear_composition_state(self):
    ...
    def is_dead_key_active(self) -> bool:
        ...
        return self.dead_key_state.get('active', False) 